...
<head>
    ...
    <title>Effectuer le classement</title>
...
<div style="height:80px;">
        ...
        <div style="display: flex; height:100px; color:#003c71; width:620px; margin:0 auto;">
            <div>
            <h1 style="border-bottom: 2px solid black; border-bottom-color: #eede99;">  CLASSEMENT DES ETUDIANTS
                ...
                <div class="col-md-6 offset-md-3" >
                    ...
                    <div class="card" style="background-color:#FFFFFF;  zoom:120%; ">
                        <div class="card-header" style="">
                            Importer le fichier Excel de fiche de voeux
                        </div>
                        <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{route('fileUploaded')}}">
                                @csrf
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{route('rankDone')}}">
                        @csrf
                        <div style="text-align:center;">
                        <button type="submit" class="btn btn-primary" style="background-color:#047cfc;">Effectuer</button>
                        </div>
                    </form>
                    @endif
                    </div>
